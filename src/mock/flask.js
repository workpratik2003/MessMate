...
// ── Serialisers ──────────────────────────────────────────────────────────────
const toUser = (u) => {
  const base = { id: u.id, username: u.username, email: u.email, phone: u.phone, role: u.role };
  ...
  return {
    ...base, plan: u.plan, startDate: u.startDate, endDate: u.endDate,
...
// ── Validation ───────────────────────────────────────────────────────────────
const baseValidation = ({ username, email, password }) => {
...
export const flask = {
  ...
  async memberRegister(data) {
    ...
    const member = {
      id: genId(), username: data.username.trim(), email: data.email.toLowerCase(),
      phone: null, password: data.password, role: 'member', sessionId: null,
      plan: null, startDate: null, endDate: null, extensionDays: 0,
      otp: null, otpExpiresAt: null, attended: [], pendingAbsences: [],
    };
